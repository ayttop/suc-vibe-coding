> **Auto-fetched** from [`pollen-robotics/reachy_mini@main`](https://github.com/pollen-robotics/reachy_mini/blob/main/skills/safe-torque.md) on 2026-07-27 · canonical SDK pin: `1.8.0`.
